"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[98],{1687:(e,t,r)=>{r.d(t,{_:()=>o});var n={"index-BBAOM8JL.js":`import { jsx, jsxs } from "react/jsx-runtime";
...
`};function o(e={}){if(!("u">typeof window))return void console.warn("Stagewise Toolbar is not supported in non-browser environments.");if(document.querySelector("stagewise-toolbar"))return void console.warn("Stagewise Toolbar is already loaded - aborting init.");let t=document.createElement("stagewise-toolbar");t.style.display="block",t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.right="0",t.style.bottom="0",t.style.width="100vw",t.style.height="100vh",t.style.zIndex="2147483647",t.style.pointerEvents="none";let r=document.createElement("iframe");r.style.display="block",r.style.border="none",r.style.overflow="hidden",r.style.margin="0",r.style.padding="0",r.style.width="100vw",r.style.height="100vh",r.style.backgroundColor="transparent",r.style.pointerEvents="none",r.style.colorScheme="normal",r.sandbox.add("allow-same-origin"),r.sandbox.add("allow-scripts"),r.sandbox.add("allow-presentation"),r.sandbox.add("allow-pointer-lock"),r.sandbox.add("allow-popups"),r.setAttribute("allowtransparency","true"),r.srcdoc='<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preconnect" href="https://rsms.me/"><link rel="stylesheet" href="https://rsms.me/inter/inter.css"></head><body style="pointer-events: none;"></body></html>',r.addEventListener("load",()=>{let t=!1,o=e=>{let n=r.contentDocument.elementFromPoint(e.clientX,e.clientY),o=n&&n!==document.body&&"HTML"!==n.tagName;o!==t&&(r.style.pointerEvents=o?"auto":"none",t=o)};window.addEventListener("mousemove",o,{capture:!0}),r.contentWindow.addEventListener("mousemove",o,{capture:!0});let a=Object.fromEntries(Object.entries(n).map(([e,t])=>[e,URL.createObjectURL(new Blob([t],{type:"text/javascript"}))]));if(a["@stagewise/toolbar/plugin-ui"]=URL.createObjectURL(new Blob(["export * from 'plugin-ui.js'"],{type:"text/javascript"})),e.plugins)for(let[t,r]of e.plugins.entries()){let e=URL.createObjectURL(new Blob([r.mainPlugin],{type:"text/javascript"}));a[`plugin-entry-${t}`]=e}let s=URL.createObjectURL(new Blob([function(e){var t,r;let n=(null==(t=e.plugins)?void 0:t.map((e,t)=>`import plugin${t} from 'plugin-entry-${t}'`).join(`
`))??"",o=`[${(null==(r=e.plugins)?void 0:r.map((e,t)=>`plugin${t}`).join(","))??""}]`,a=JSON.stringify({...e,plugins:"__PLUGIN_PLACEHOLDER__"});return a=a.replace('"__PLUGIN_PLACEHOLDER__"',o),`${n}

const config = ${a};

export default config;
`}(e)],{type:"text/javascript"}));a["@stagewise/toolbar/config"]=s;let i={react:"https://esm.sh/react@19.1.0","react-dom":"https://esm.sh/react-dom@19.1.0","react-dom/client":"https://esm.sh/react-dom@19.1.0/client","react/jsx-runtime":"https://esm.sh/react@19.1.0/jsx-runtime",...a},l=r.contentDocument.createElement("script");l.type="importmap",l.textContent=`{"imports":${JSON.stringify(i)}}`,r.contentDocument.head.appendChild(l);let c=r.contentDocument.createElement("script");c.type="module",c.textContent="import('index.js');",r.contentDocument.head.appendChild(c)}),t.appendChild(r),document.body.appendChild(t)}}}]);